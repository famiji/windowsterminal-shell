    ...
    [bool]$includePreview)
{
    ...
    if ($layout -eq "Default") {
        ...
        New-ItemProperty -Path 'Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\shell\MenuTerminalAdmin' -Name 'MUIVerb' -PropertyType String -Value 'Open Terminal as administrator' | Out-Null
        ...
        New-ItemProperty -Path 'Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\Background\shell\MenuTerminalAdmin' -Name 'MUIVerb' -PropertyType String -Value 'Open Terminal as administrator' | Out-Null
        ...
        CreateMenuItem "Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\shell\MenuTerminalAdminMini" "Open Terminal as administrator" $icon $elevated $true   
        ...
        CreateMenuItem "Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\Background\shell\MenuTerminalAdminMini" "Open Terminal as administrator" $icon $elevated $true   
        return
    }
